...
public class Player {
    ...
    public void addCoins(int bet) {this.coins += bet;}
    ...
    public void setWinningHand(int cardCombnation) {this.cardCombnation = cardCombnation;}
    public int getWinningHand(){return cardCombnation;}
}
