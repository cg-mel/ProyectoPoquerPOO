...
public class FiveCardDraw extends PokerBaseClass{
    ...
    public void firstBet(){
        ...
        do {
            currentTopBet = Integer.parseInt(JOptionPane.showInputDialog("Ingrese su apuesta. Fichas actuales: " + players.get(currentPlayer).getCoins()));
    ...
    public void cardReplacer(){
        if(players.get(currentPlayer).getHandSize()<5){
            ...
            }while(players.get(currentPlayer).getHandSize()<5);
        }
    }
}
